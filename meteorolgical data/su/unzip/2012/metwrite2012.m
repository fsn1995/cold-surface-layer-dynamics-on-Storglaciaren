...
clear indata 
% New rain gauge after 1 July. Old was calibrated to 0.16 mm/tip
%  new is calibrated to 0.1 mm/tip
hourly(4345:end,13) = hourly(4345:end,13)*0.1/0.16;
daily(182:end,1) = daily(182:end,13)*0.1/0.16;
