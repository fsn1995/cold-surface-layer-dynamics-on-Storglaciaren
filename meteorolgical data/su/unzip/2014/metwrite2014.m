...
clear indata 
% Adjusting precipitation gauge calibration from 0.16 mm per pulse
%  to 0.1 mm per pulse until programming change corrected raw data
hourly(1:4451,13) = hourly(1:4451,13)*0.1/0.16;
daily(1:185,1) = daily(1:185,13)*0.1/0.16;
...
subplot(rows,1,4)
 plot(H(1:n:end,1),H(1:n:end,13),'r.','MarkerSize',2)
 hold on;
